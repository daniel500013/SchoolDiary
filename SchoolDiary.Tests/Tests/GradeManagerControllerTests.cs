...
{
    public class GradeManagerControllerTests
    {
        private HttpClient Client { get; set; }

        public GradeManagerControllerTests()
        {
        ...
        [Fact]
        public async Task GetLessonGrades_WithoutParams_ReturnOkRequest()
        {
            var response = await Client.GetAsync("/api/GradeManager");
